...
document.addEventListener("DOMContentLoaded", function () {
    let interval; // Store the interval for clearing/resetting
    ...
    function startCountdown(targetDate) {
        ...
        interval = setInterval(() => {
            ...
            if (distance <= 0) {
                ...
                document.getElementById("timer").innerHTML = "The wait is over! ❤️";
                return;
            }
